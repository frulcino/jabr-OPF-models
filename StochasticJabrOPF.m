function [PGn, QGn, PGe, QGe, cn, sn, un, ce, se, ue, Pn, Qn, Pe, Qe, Fop, Frisk, F] = StochasticJabrOPF(casename,wind_error_file_nameNs, Nxi, beta, rho, Varepsilon)
%StochasticJabrOPF 
...
% wind_error_file_name: string name of file containing error samples for
...
%from CESI wind farm
error_scenarios = readmatrix(wind_error_file_name);
