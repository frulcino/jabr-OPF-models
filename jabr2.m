...
%TODO sto usando la corretta admittance matrix?
%TODO: recover original variables from c and 
%TODO:come considerare reference bus?
%TODO: shunt admittance at each bus
%TODO: p.u.?
%TODO: angle difference constraints
%TODO: add warning if assumptions on voltage difference bounds fail 
%TODO: BienstockLinModel
%TODO: OurLinModel
%TODO: Reduce model Gap?
...
cvx_solver GUROBi
    ...
    disp("adding branch constraints...")
        for b = 1:Nbranch %constraints over branch b
            ...
            %jabr inequality in convex form
            norm([2*c(b),2*s(b),u(f)-u(t)]) <= u(f) + u(t); 
       ...
       disp("finished adding branch constraints, adding bus constraints...")
